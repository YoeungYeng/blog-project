    ...
    <section class="w-3/4 bg-white p-6 shadow-md rounded-lg">
        ...
        <div class="space-y-6">
            <article class="flex gap-4 border-b pb-4">
                <img src="{{ asset('https://placehold.co/600x400') }}" alt="Post Image" class="w-32 h-32 object-cover rounded">
                <div>
            ...
            <article class="flex gap-4 border-b pb-4">
                <img src="{{ asset('https://placehold.co/600x400') }}" alt="Post Image" class="w-32 h-32 object-cover rounded">
                <div>
                    <h3 class="text-lg font-semibold"><a href="{{route('article')}}" class="hover:underline">Another Blog Post</a></h3>
